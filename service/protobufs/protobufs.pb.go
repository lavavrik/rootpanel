...
type CPU struct {
	...
	Load []uint32 `protobuf:"varint,1,rep,packed,name=load,proto3" json:"load,omitempty"`
}
...
type Disk struct {
	...
	ReadSpeed  uint64 `protobuf:"varint,2,opt,name=read_speed,json=readSpeed,proto3" json:"read_speed,omitempty"`
	WriteSpeed uint64 `protobuf:"varint,3,opt,name=write_speed,json=writeSpeed,proto3" json:"write_speed,omitempty"`
}
...
func (x *Disk) GetReadSpeed() uint64 {
	if x != nil {
		return x.ReadSpeed
	}
	return 0
...
func (x *Disk) GetWriteSpeed() uint64 {
	if x != nil {
		return x.WriteSpeed
	}
	return 0
...
func (x *Network) GetBytesReceived() uint64 {
	if x != nil {
...
func (x *DataPoint) GetMemory() *Memory {
	if x != nil {
		return x.Memory
	}
	return nil
...
func (x *DataPoint) GetDisks() []*Disk {
	if x != nil {
		return x.Disks
	}
	return nil
...
func (x *DataPoint) GetNetwork() *Network {
	if x != nil {
		return x.Network
	}
	return nil
...
var file___proto_rawDesc = []byte{
	,
	...
	0x62, 0x79, 0x74, 0x65, 0x73, 0x52, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x64, 0x22, 0xcb, 0x01,
	...
	,
...
var file___proto_goTypes = []interface{}{
	(*CPU)(nil),       // 0: protobufs.CPU
	(*Memory)(nil),    // 1: protobufs.Memory
	(*Disk)(nil),      // 2: protobufs.Disk
	(*Network)(nil),   // 3: protobufs.Network
	(*DataPoint)(nil), // 4: protobufs.DataPoint
}
var file___proto_depIdxs = []int32{
	0, // 0: protobufs.DataPoint.cpu:type_name -> protobufs.CPU
	1, // 1: protobufs.DataPoint.memory:type_name -> protobufs.Memory
	2, // 2: protobufs.DataPoint.disks:type_name -> protobufs.Disk
	3, // 3: protobufs.DataPoint.network:type_name -> protobufs.Network
